/*
  # Rename average_response_time columns

  1. Changes
    - Rename average_response_time to session_average_response_time in game_sessions table
    - Rename average_response_time to statistics_average_response_time in user_statistics table
...
RENAME COLUMN average_response_time TO session_average_response_time;

ALTER TABLE user_statistics 
RENAME COLUMN average_response_time TO statistics_average_response_time;

-- Update session stats function
...
BEGIN
  ...
  SET 
    ...
    session_average_response_time = v_avg_response_time
...
BEGIN
  ...
  SELECT 
    ...
    AVG(session_average_response_time) as average_response_time,
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(AVG(gs.statistics_average_response_time), 0)::DOUBLE PRECISION as average_response_time,
