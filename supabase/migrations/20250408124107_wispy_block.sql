/*
  # Fix game sessions schema and statistics

  1. Changes
    - Ensure game_sessions has correct column names
    - Update triggers to use correct column names
    - Clean up any duplicate columns
    
  2. Purpose
    - Fix column name mismatch causing errors
    - Ensure consistent naming across database
*/
...
-- Update the session stats trigger function to use correct column names
