/*
  # Update statistics trigger to avoid counting duplicates

  1. Changes
    - Modify update_user_statistics_trigger to count unique correct words
    - Use DISTINCT to avoid counting the same word multiple times
    - Maintain other statistics calculations (total sessions, average response time)

  2. Technical Details
    - Groups word attempts by word_id to count unique correct words
    - Uses window functions for accurate statistics
    - Preserves existing functionality for other metrics
*/
